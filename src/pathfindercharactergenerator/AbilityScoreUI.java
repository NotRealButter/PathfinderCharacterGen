...
public class AbilityScoreUI extends MyJPanel {
    ...
    private void initComponents() {
        ...
        dexBox.setText("jTextField3");

        intBox.setText("jTextField4");

        wisBox.setText("jTextField5");

        chaBox.setText("jTextField6");
